...
| L6-117 | P59 | §8.3、§10 | `atlas_manage set_property` 不传 path | `MISSING_PARAM` |
| L6-118 | P59 | §8.3、§10 | `gui_manage set_property` 不传 path | `MISSING_PARAM` |
| L6-119 | P59 | §8.3、§10 | `tilemap_manage set_property` 不传 path | `MISSING_PARAM` |
