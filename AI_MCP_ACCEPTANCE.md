...
**P1**–**P57** 已在打包编辑器上按 ID 实跑。**P58** 是需求里已写、合同还没编号的 atlas add_image / gui add_texture 缺必填值。关编辑器的磁盘 / live 路径（L3-05）是其中一条，不是整表的前提。
...
P1–P58 必须实跑；漏跑 = 失败。禁止把没跑的条目标成通过。仅 L5-07（可选截屏）允许 `SKIP`。
...
优先级：**P0** = 签字必须过。**P1**–**P57** = 已在打包编辑器上跑过。**P58** = 本轮按需求补的编号；失败与 P0 一样要修，不得从合同删掉。
...
| L1-62 | P28 | §8.2、§10 | `script_patch` 有 path 不传 old_text | `MISSING_PARAM` |
| L1-63 | P28 | §8.2、§10 | `script_patch` 有 path 与 old_text 不传 new_text | `MISSING_PARAM` |
| L1-64 | P28 | §8.1、§10 | `gameobject_get_properties` 有 id 不传 collection | `MISSING_PARAM` |
| L1-65 | P40 | §8.3、§10 | `script_manage detach` 不传 id | `MISSING_PARAM` |
...
| L6-30 | P29 | §8.3、§10 | `atlas_manage set_property` 有 path 不传 property | `MISSING_PARAM` |
| L6-31 | P29 | §8.3、§10 | `gui_manage set_node` 有 path 与 id 不传 property | `MISSING_PARAM` |
| L6-32 | P29 | §8.3、§10 | `tilemap_manage set_tile` 有 path / layer / x / y 不传 tile | `MISSING_PARAM` |
| L6-33 | P30 | §8.3、§10 | `atlas_manage remove` 有 path 不传 id | `MISSING_PARAM` |
| L6-34 | P30 | §8.3、§10 | `gui_manage set_node` 有 path 不传 id | `MISSING_PARAM` |
| L6-35 | P30 | §8.3、§10 | `tilemap_manage set_tile` 有 path 不传 x / y | `MISSING_PARAM` |
| L6-36 | P31 | §8.3、§10 | `camera_manage get` 不传 path | `MISSING_PARAM` |
| L6-37 | P31 | §8.3、§10 | `camera_manage add` 不传 collection / id / path | `MISSING_PARAM` |
| L6-38 | P31 | §8.3、§10 | `atlas_manage create` 不传 path | `MISSING_PARAM` |
...
| L6-45 | P34 | §8.3、§10 | `input_binding_manage add_key` 有 path 不传 input | `MISSING_PARAM` |
| L6-46 | P34 | §8.3、§10 | `material_manage create` 不传 path | `MISSING_PARAM` |
| L6-47 | P34 | §8.3、§10 | `particlefx_manage create` 不传 path | `MISSING_PARAM` |
| L6-48 | P35 | §8.3、§10 | `font_manage create` 不传 path | `MISSING_PARAM` |
| L6-49 | P35 | §8.3、§10 | `sound_manage create` 不传 path | `MISSING_PARAM` |
| L6-50 | P35 | §8.3、§10 | `tilesource_manage create` 不传 path | `MISSING_PARAM` |
...
| L6-57 | P38 | §8.3、§10 | `collisionobject_manage create` 不传 path | `MISSING_PARAM` |
| L6-58 | P38 | §8.3、§10 | `cubemap_manage create` 不传 path | `MISSING_PARAM` |
| L6-59 | P38 | §8.3、§10 | `mesh_manage create` 不传 path | `MISSING_PARAM` |
| L6-60 | P39 | §8.3、§10 | `texture_profiles_manage create` 不传 path | `MISSING_PARAM` |
| L6-61 | P39 | §8.3、§10 | `compute_manage create` 不传 path | `MISSING_PARAM` |
| L6-62 | P39 | §8.3、§10 | `appmanifest_manage create` 不传 path | `MISSING_PARAM` |
| L6-63 | P40 | §8.3、§10 | `render_manage create` 不传 path | `MISSING_PARAM` |
| L6-64 | P40 | §8.3、§10 | `atlas_manage get` 不传 path | `MISSING_PARAM` |
| L6-65 | P41 | §8.3、§10 | `input_binding_manage create` 不传 path | `MISSING_PARAM` |
| L6-66 | P41 | §8.3、§10 | `gui_manage get` 不传 path | `MISSING_PARAM` |
| L6-67 | P41 | §8.3、§10 | `tilemap_manage get` 不传 path | `MISSING_PARAM` |
| L6-68 | P42 | §8.3、§10 | `material_manage get` 不传 path | `MISSING_PARAM` |
| L6-69 | P42 | §8.3、§10 | `particlefx_manage get` 不传 path | `MISSING_PARAM` |
| L6-70 | P42 | §8.3、§10 | `font_manage get` 不传 path | `MISSING_PARAM` |
| L6-71 | P43 | §8.3、§10 | `sound_manage get` 不传 path | `MISSING_PARAM` |
| L6-72 | P43 | §8.3、§10 | `tilesource_manage get` 不传 path | `MISSING_PARAM` |
| L6-73 | P43 | §8.3、§10 | `gamepads_manage get` 不传 path | `MISSING_PARAM` |
| L6-74 | P44 | §8.3、§10 | `display_profiles_manage get` 不传 path | `MISSING_PARAM` |
| L6-75 | P44 | §8.3、§10 | `model_manage get` 不传 path | `MISSING_PARAM` |
| L6-76 | P44 | §8.3、§10 | `factory_manage get` 不传 path | `MISSING_PARAM` |
| L6-77 | P45 | §8.3、§10 | `collectionfactory_manage get` 不传 path | `MISSING_PARAM` |
| L6-78 | P45 | §8.3、§10 | `collectionproxy_manage get` 不传 path | `MISSING_PARAM` |
| L6-79 | P45 | §8.3、§10 | `collisionobject_manage get` 不传 path | `MISSING_PARAM` |
| L6-80 | P46 | §8.3、§10 | `cubemap_manage get` 不传 path | `MISSING_PARAM` |
| L6-81 | P46 | §8.3、§10 | `mesh_manage get` 不传 path | `MISSING_PARAM` |
| L6-82 | P46 | §8.3、§10 | `texture_profiles_manage get` 不传 path | `MISSING_PARAM` |
| L6-83 | P47 | §8.3、§10 | `compute_manage get` 不传 path | `MISSING_PARAM` |
| L6-84 | P47 | §8.3、§10 | `appmanifest_manage get` 不传 path | `MISSING_PARAM` |
| L6-85 | P47 | §8.3、§10 | `render_manage get` 不传 path | `MISSING_PARAM` |
| L6-86 | P48 | §8.3、§10 | `input_binding_manage get` 不传 path | `MISSING_PARAM` |
| L6-87 | P48 | §8.3、§10 | `atlas_manage` 不传 op | `MISSING_PARAM` |
| L6-88 | P48 | §8.3、§10 | `gui_manage` 不传 op | `MISSING_PARAM` |
| L6-89 | P49 | §8.3、§10 | `tilemap_manage` 不传 op | `MISSING_PARAM` |
| L6-90 | P49 | §8.3、§10 | `input_binding_manage` 不传 op | `MISSING_PARAM` |
| L6-91 | P49 | §8.3、§10 | `material_manage` 不传 op | `MISSING_PARAM` |
| L6-92 | P50 | §8.3、§10 | `particlefx_manage` 不传 op | `MISSING_PARAM` |
| L6-93 | P50 | §8.3、§10 | `font_manage` 不传 op | `MISSING_PARAM` |
| L6-94 | P50 | §8.3、§10 | `sound_manage` 不传 op | `MISSING_PARAM` |
| L6-95 | P51 | §8.3、§10 | `tilesource_manage` 不传 op | `MISSING_PARAM` |
| L6-96 | P51 | §8.3、§10 | `gamepads_manage` 不传 op | `MISSING_PARAM` |
| L6-97 | P51 | §8.3、§10 | `display_profiles_manage` 不传 op | `MISSING_PARAM` |
| L6-98 | P52 | §8.3、§10 | `model_manage` 不传 op | `MISSING_PARAM` |
| L6-99 | P52 | §8.3、§10 | `factory_manage` 不传 op | `MISSING_PARAM` |
| L6-100 | P52 | §8.3、§10 | `collectionfactory_manage` 不传 op | `MISSING_PARAM` |
| L6-101 | P53 | §8.3、§10 | `collectionproxy_manage` 不传 op | `MISSING_PARAM` |
| L6-102 | P53 | §8.3、§10 | `collisionobject_manage` 不传 op | `MISSING_PARAM` |
| L6-103 | P53 | §8.3、§10 | `cubemap_manage` 不传 op | `MISSING_PARAM` |
| L6-104 | P54 | §8.3、§10 | `mesh_manage` 不传 op | `MISSING_PARAM` |
| L6-105 | P54 | §8.3、§10 | `texture_profiles_manage` 不传 op | `MISSING_PARAM` |
| L6-106 | P54 | §8.3、§10 | `compute_manage` 不传 op | `MISSING_PARAM` |
| L6-107 | P55 | §8.3、§10 | `appmanifest_manage` 不传 op | `MISSING_PARAM` |
| L6-108 | P55 | §8.3、§10 | `render_manage` 不传 op | `MISSING_PARAM` |
| L6-109 | P56 | §8.3、§10 | `tilemap_manage set_tile_set` 有 path 不传 tile_set | `MISSING_PARAM` |
| L6-110 | P56 | §8.3、§10 | `gui_manage set_script` 有 path 不传 script | `MISSING_PARAM` |
| L6-111 | P56 | §8.3、§10 | `tilesource_manage set_image` 有 path 不传 image | `MISSING_PARAM` |
| L6-112 | P57 | §8.3、§10 | `font_manage set_font` 有 path 不传 font | `MISSING_PARAM` |
| L6-113 | P57 | §8.3、§10 | `sound_manage set_sound` 有 path 不传 sound | `MISSING_PARAM` |
| L6-114 | P57 | §8.3、§10 | `render_manage set_script` 有 path 不传 script | `MISSING_PARAM` |
| L6-115 | P58 | §8.3、§10 | `atlas_manage add_image` 有 path 不传 image | `MISSING_PARAM` |
| L6-116 | P58 | §8.3、§10 | `gui_manage add_texture` 有 path 不传 texture | `MISSING_PARAM` |
